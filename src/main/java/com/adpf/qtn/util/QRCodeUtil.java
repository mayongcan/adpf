...
public class QRCodeUtil {
	...
	public static void main(String[] args) {
		...
		String destPath = "E:\\work_space\\project\\adpf\\adpf-web\\WebContent\\tnpmImage\\qrcode.jpg";
		try {
		...
		// 验证图片是否含有二维码
		// String destPath1 = System.getProperty("user.dir") + "/target/3.jpg";
		// try {
	...
	public String changeNumber(long number) {
		String num = "000"+number;
