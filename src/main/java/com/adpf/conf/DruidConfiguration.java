...
public class DruidConfiguration {
	...
	public ServletRegistrationBean druidServlet() {
	    ...
	    servletRegistrationBean.addUrlMappings("/api/adpf/druidMonitor/*");
	...
	public FilterRegistrationBean filterRegistrationBean() {
	    ...
	    filterRegistrationBean.addInitParameter("exclusions", "*.js,*.gif,*.jpg,*.png,*.css,*.ico,/api/adpf/druidMonitor/*");
