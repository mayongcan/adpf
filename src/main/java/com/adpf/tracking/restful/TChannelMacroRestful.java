 ...
 */
@RestController
@RequestMapping("/api/adpf/tracking/channelmacro")
public class TChannelMacroRestful {

	protected static final Logger logger = LogManager.getLogger(TChannelMacroRestful.class);
    
    @Autowired
    private TChannelMacroService tChannelMacroService;
	...
	public JSONObject getList(HttpServletRequest request, @RequestParam Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = tChannelMacroService.getList(pageable, tChannelMacro, params);
			}
		}catch(Exception e){
	...
	public JSONObject add(HttpServletRequest request, @RequestBody Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = tChannelMacroService.add(params, userInfo);
			}
		}catch(Exception e){
	...
	public JSONObject edit(HttpServletRequest request, @RequestBody Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = tChannelMacroService.edit(params, userInfo);
			}
		}catch(Exception e){
	...
	public JSONObject del(HttpServletRequest request,@RequestBody String idsList){
		...
		try {
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = tChannelMacroService.del(idsList, userInfo);
			}
		} catch (Exception e) {
