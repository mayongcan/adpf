 ...
 */
package com.adpf.modules.create.restful;
 ...
 */
@RestController
@RequestMapping("/api/adpf/release/create")
public class AdpfCreateAdvertisementRestful {

	protected static final Logger logger = LogManager.getLogger(AdpfCreateAdvertisementRestful.class);
    
    @Autowired
    private AdpfCreateAdvertisementService adpfCreateAdvertisementService;
	...
	public JSONObject getList(HttpServletRequest request, @RequestParam Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = adpfCreateAdvertisementService.getList(pageable, adpfCreateAdvertisement, params);
			}
		}catch(Exception e){
	...
	public JSONObject add(HttpServletRequest request, @RequestBody Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = adpfCreateAdvertisementService.add(params, userInfo);
			}
		}catch(Exception e){
	...
	public JSONObject edit(HttpServletRequest request, @RequestBody Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = adpfCreateAdvertisementService.edit(params, userInfo);
			}
		}catch(Exception e){
	...
	public JSONObject del(HttpServletRequest request,@RequestBody String idsList){
		...
		try {
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = adpfCreateAdvertisementService.del(idsList, userInfo);
			}
		} catch (Exception e) {
