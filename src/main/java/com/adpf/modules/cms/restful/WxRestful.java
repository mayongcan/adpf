...
import com.adpf.modules.cms.util.HttpUtil;
...
public class WxRestful {
	...
	protected static final Logger log = LogManager.getLogger(AdpfCmsArticleRestful.class);
	

	//@Value("${wechat.appId}")
    private String appId="wx2aa1aa6d129512aa";
   // @Value("${wechat.appSecret}")
    private String appSecret="3d34957ef6abd011c066fe931b0fd822";
  ...
  //微信参数
    ...
    public Map<String, String> getWechatParam(String url){
		...
		log.info("AAAAAAAAAAAAAAAA.....进入接口");
        //当前时间
