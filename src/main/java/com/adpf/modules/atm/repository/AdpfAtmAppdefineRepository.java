 ...
 */
@Repository
public interface AdpfAtmAppdefineRepository extends JpaRepository<AdpfAtmAppdefine, Long>, JpaSpecificationExecutor<AdpfAtmAppdefine>, AdpfAtmAppdefineRepositoryCustom {
	...
	@Query(value = "UPDATE adpf_atm_appdefine "
