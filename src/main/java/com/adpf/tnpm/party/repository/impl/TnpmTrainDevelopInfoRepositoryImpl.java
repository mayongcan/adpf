...
import com.adpf.tnpm.party.repository.custom.TnpmTrainDevelopInfoRepositoryCustom;

public class TnpmTrainDevelopInfoRepositoryImpl extends BaseRepository implements TnpmTrainDevelopInfoRepositoryCustom{
	 ...
	 * @return
	 */
	private SqlParams genListWhere(String sql, TnpmTrainDevelopInfo tnpmTrainDevelopInfo, Map<String, Object> params){
		SqlParams sqlParams = new SqlParams();
		//sql=sql+"AND tb.PEOPLE_ID="+params.get("peopleId");
		sqlParams.querySql.append(sql);
		if(StringUtils.isNotBlank((String)params.get("peopleId"))) {
