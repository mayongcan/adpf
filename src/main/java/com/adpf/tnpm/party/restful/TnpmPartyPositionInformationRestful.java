 ...
 */
@RestController
@RequestMapping("/api/adpf/tnpm/position")
public class TnpmPartyPositionInformationRestful {

	protected static final Logger logger = LogManager.getLogger(TnpmPartyPositionInformationRestful.class);
    
    @Autowired
    private TnpmPartyPositionInformationService tnpmPartyPositionInformationService;
	...
	public JSONObject getList(HttpServletRequest request, @RequestParam Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = tnpmPartyPositionInformationService.getList(pageable, tnpmPartyPositionInformation, params);
			}
		}catch(Exception e){
	...
	public JSONObject add(HttpServletRequest request, @RequestBody Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = tnpmPartyPositionInformationService.add(params, userInfo);
			}
		}catch(Exception e){
	...
	public JSONObject edit(HttpServletRequest request, @RequestBody Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = tnpmPartyPositionInformationService.edit(params, userInfo);
			}
		}catch(Exception e){
	...
	public JSONObject del(HttpServletRequest request,@RequestBody String idsList){
		...
		try {
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = tnpmPartyPositionInformationService.del(idsList, userInfo);
			}
		} catch (Exception e) {
