 ...
 */
@RestController
@RequestMapping("/api/adpf/tnpm/family")
public class TnpmFamilyInfoRestful {

	protected static final Logger logger = LogManager.getLogger(TnpmFamilyInfoRestful.class);
    
    @Autowired
    private TnpmFamilyInfoService tnpmFamilyInfoService;
