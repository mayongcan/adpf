 ...
 */
@RestController
@RequestMapping("/api/adpf/tnpm/reward")
public class TnpmRewardsInfoRestful {

	protected static final Logger logger = LogManager.getLogger(TnpmRewardsInfoRestful.class);
    
    @Autowired
    private TnpmRewardsInfoService tnpmRewardsInfoService;
