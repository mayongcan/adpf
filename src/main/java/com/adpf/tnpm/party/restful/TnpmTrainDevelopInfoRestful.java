 ...
 */
@RestController
@RequestMapping("/api/adpf/tnpm/trainDevelop")
public class TnpmTrainDevelopInfoRestful {

	protected static final Logger logger = LogManager.getLogger(TnpmTrainDevelopInfoRestful.class);
    
    @Autowired
    private TnpmTrainDevelopInfoService tnpmTrainDevelopInfoService;
