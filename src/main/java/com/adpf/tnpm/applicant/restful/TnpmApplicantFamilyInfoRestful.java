 ...
 */
@RestController
@RequestMapping("/api/adpf/tnpm/applicant/family")
public class TnpmApplicantFamilyInfoRestful {

	protected static final Logger logger = LogManager.getLogger(TnpmApplicantFamilyInfoRestful.class);
    
    @Autowired
    private TnpmApplicantFamilyInfoService tnpmFamilyInfoService;
	...
	public JSONObject getList(HttpServletRequest request, @RequestParam Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = tnpmFamilyInfoService.getList(pageable, tnpmFamilyInfo, params);
			}
		}catch(Exception e){
	...
	public JSONObject add(HttpServletRequest request, @RequestBody Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = tnpmFamilyInfoService.add(params, userInfo);
			}
		}catch(Exception e){
	...
	public JSONObject edit(HttpServletRequest request, @RequestBody Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = tnpmFamilyInfoService.edit(params, userInfo);
			}
		}catch(Exception e){
	...
	public JSONObject del(HttpServletRequest request,@RequestBody String idsList){
		...
		try {
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = tnpmFamilyInfoService.del(idsList, userInfo);
			}
		} catch (Exception e) {
