 ...
 */
@RestController
@RequestMapping("/api/adpf/tnpm/applicant/reward")
public class TnpmApplicantRewardsInfoRestful {

	protected static final Logger logger = LogManager.getLogger(TnpmApplicantRewardsInfoRestful.class);
    
    @Autowired
    private TnpmApplicantRewardsInfoService tnpmRewardsInfoService;
	...
	public JSONObject getList(HttpServletRequest request, @RequestParam Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = tnpmRewardsInfoService.getList(pageable, tnpmRewardsInfo, params);
			}
		}catch(Exception e){
	...
	public JSONObject add(HttpServletRequest request, @RequestBody Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = tnpmRewardsInfoService.add(params, userInfo);
			}
		}catch(Exception e){
	...
	public JSONObject edit(HttpServletRequest request, @RequestBody Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = tnpmRewardsInfoService.edit(params, userInfo);
			}
		}catch(Exception e){
	...
	public JSONObject del(HttpServletRequest request,@RequestBody String idsList){
		...
		try {
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = tnpmRewardsInfoService.del(idsList, userInfo);
			}
		} catch (Exception e) {
