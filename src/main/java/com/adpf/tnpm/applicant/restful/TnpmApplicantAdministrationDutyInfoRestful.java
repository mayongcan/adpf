 ...
 */
@RestController
@RequestMapping("/api/adpf/tnpm/applicant/administrationDuty")
public class TnpmApplicantAdministrationDutyInfoRestful {

	protected static final Logger logger = LogManager.getLogger(TnpmApplicantAdministrationDutyInfoRestful.class);
    
    @Autowired
    private TnpmApplicantAdministrationDutyInfoService tnpmAdministrationDutyInfoService;
