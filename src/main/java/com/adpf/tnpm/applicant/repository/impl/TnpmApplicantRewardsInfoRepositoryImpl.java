...
public class TnpmApplicantRewardsInfoRepositoryImpl extends BaseRepository implements TnpmApplicantRewardsInfoRepositoryCustom{
	 ...
	 * @return
	 */
	private SqlParams genListWhere(String sql, TnpmApplicantRewardsInfo tnpmRewardsInfo, Map<String, Object> params){
