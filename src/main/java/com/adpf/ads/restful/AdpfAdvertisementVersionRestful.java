 ...
 */
@RestController
@RequestMapping("/api/adpf/release/version")
public class AdpfAdvertisementVersionRestful {

	protected static final Logger logger = LogManager.getLogger(AdpfAdvertisementVersionRestful.class);
    
    @Autowired
    private AdpfAdvertisementVersionService adpfAdvertisementVersionService;
	...
	public JSONObject getList(HttpServletRequest request, @RequestParam Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = adpfAdvertisementVersionService.getList(pageable, adpfAdvertisementVersion, params);
			}
		}catch(Exception e){
	...
	public JSONObject add(HttpServletRequest request, @RequestBody Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = adpfAdvertisementVersionService.add(params, userInfo);
			}
		}catch(Exception e){
	...
	public JSONObject edit(HttpServletRequest request, @RequestBody Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = adpfAdvertisementVersionService.edit(params, userInfo);
			}
		}catch(Exception e){
	...
	public JSONObject del(HttpServletRequest request,@RequestBody String idsList){
		...
		try {
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = adpfAdvertisementVersionService.del(idsList, userInfo);
			}
		} catch (Exception e) {
