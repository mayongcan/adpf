 ...
 */
package com.adpf.issue.restful;
 ...
 */
@RestController
@RequestMapping("/api/adpf/issue")
public class AdvIssueRestful {

	protected static final Logger logger = LogManager.getLogger(AdvIssueRestful.class);
    
    @Autowired
    private AdvIssueService advIssueService;
	...
	public JSONObject getList(HttpServletRequest request, @RequestParam Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = advIssueService.getList(pageable, advIssue, params);
			}
		}catch(Exception e){
	...
	public JSONObject add(HttpServletRequest request, @RequestBody Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = advIssueService.add(params, userInfo);
			}
		}catch(Exception e){
	...
	public JSONObject edit(HttpServletRequest request, @RequestBody Map<String, Object> params){
		...
		try{
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = advIssueService.edit(params, userInfo);
			}
		}catch(Exception e){
	...
	public JSONObject del(HttpServletRequest request,@RequestBody String idsList){
		...
		try {
			...
			if(userInfo == null) json = RestfulRetUtils.getErrorNoUser();
				...
				json = advIssueService.del(idsList, userInfo);
			}
		} catch (Exception e) {
